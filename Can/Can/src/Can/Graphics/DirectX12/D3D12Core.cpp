...
namespace Can::graphics::d3d12::core
{
	namespace
	{
		...
		std::vector<IUnknown*> deferred_releases[frame_buffer_count]{};
	...
	bool initialize()
	{
...
#ifdef _DEBUG
		{
			...
			{
				OutputDebugStringA("Warning: D3D12 Debug interface is not available. Verify that Graphics Tools option is installed in this device.\n");
			}

...
inline double Noise::Dot(int g[4], double x, double y, double z, double t) { return g[0] * x + g[1] * y + g[2] * z + g[3] * t; }
inline double Noise::Dot(int g[3], double x, double y, double z) { return g[0] * x + g[1] * y + g[2] * z; }
inline double Noise::Dot(int g[2], double x, double y) { return g[0] * x + g[1] * y; }
inline int Noise::FastFloor(double x) { return x >= 0 ? (int)x : (int)x - 1; }
...
Some changes by Emre Can Hacýosmanoðlu.
*/
...
public:
	...
	static inline double Dot(int g[3], double x, double y, double z);
	static inline double Dot(int g[2], double x, double y);
	static inline int FastFloor(double x);

private:
	/// Initial permutation table
	int Source[RandomSize] = {
